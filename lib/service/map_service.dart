...
class MapServices {
  final String key = 'AIzaSyCOG0CyGMQFVhCA4cZL0ClaE63LdxUf4hA';
  final String types = 'geocode';

  Future<List<AutoCompleteResult>> searchPlaces(String searchInput) async {
    final String url =
        'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$searchInput&types=$types&key=$key&components=country:vn';
